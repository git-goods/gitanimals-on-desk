...
// for `gitanimals-prefs.json`. It has zero dependencies on Electron, the store, the
...
//
// Bad-file handling: read failure → backup as `gitanimals-prefs.json.bak` → return defaults.
